...
"""This print should return 200. This will prove that the following work:
...
"""This print should return the version of anystyle-cli. This will prove that the following work:
    - The ruby installation
    - The anystyle-cli installation
    - The connectivity between python and anystyle-cli
"""
print(os.system("anystyle-cli --version"))
